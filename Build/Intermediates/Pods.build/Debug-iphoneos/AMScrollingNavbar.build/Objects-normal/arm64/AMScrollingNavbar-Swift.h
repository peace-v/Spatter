...
/// An array of <code>UIView</code>s that will follow the navbar
@property (nonatomic, copy) NSArray<UIView *> * _Nonnull followers;
...
///
/// \param followers An array of <code>UIView</code>s that will follow the navbar
///
- (void)followScrollView:(UIView * _Nonnull)scrollableView delay:(double)delay scrollSpeedFactor:(double)scrollSpeedFactor followers:(NSArray<UIView *> * _Nonnull)followers;
...
@interface ScrollingNavigationViewController : UIViewController <UIScrollViewDelegate, UINavigationControllerDelegate>
